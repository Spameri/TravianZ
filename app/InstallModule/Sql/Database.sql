...
INSERT INTO `unit` (`id`, `name`, `attack`, `defence_infantry`, `defence_calvary`, `wood`, `clay`, `iron`, `crop`, `pop`, `speed`, `time`, `capacity`, `type`, `tribe`)
VALUES
  (1, 'Legionnaire', 40, 35, 50, 120, 100, 150, 30, 1, 6, 1600, 50, 1, 1),
  (2, 'Praetorian', 30, 65, 35, 100, 130, 160, 70, 1, 5, 1760, 20, 1, 1),
  (3, 'Imperian', 70, 40, 25, 150, 160, 210, 80, 1, 7, 1920, 50, 1, 1),
  (4, 'Equites Legati', 0, 20, 10, 140, 160, 20, 40, 2, 16, 1360, 0, 7, 1),
  (5, 'Equites Imperatoris', 120, 65, 50, 550, 440, 320, 100, 3, 14, 2640, 100, 2, 1),
  (6, 'Equites Caesaris', 180, 80, 105, 550, 640, 800, 180, 4, 10, 3520, 70, 2, 1),
  (7, 'Battering Ram', 60, 30, 75, 900, 350, 500, 70, 3, 4, 4600, 0, 3, 1),
  (8, 'Fire Catapult', 75, 60, 10, 950, 1350, 600, 90, 6, 3, 9000, 0, 4, 1),
  (9, 'Senator', 50, 40, 30, 30750, 27200, 45000, 37500, 5, 5, 90700, 0, 8, 1),
  (10, 'Settler', 0, 80, 80, 5800, 5300, 7200, 5500, 1, 5, 26900, 3000, 6, 1),
  (11, 'Maceman', 40, 20, 5, 95, 75, 40, 40, 1, 7, 720, 60, 1, 2),
  (12, 'Spearman', 10, 35, 60, 145, 70, 85, 40, 1, 7, 1120, 40, 1, 2),
  (13, 'Axeman', 60, 30, 30, 130, 120, 170, 70, 1, 6, 1200, 50, 1, 2),
  (14, 'Scout', 0, 10, 5, 160, 100, 50, 50, 1, 9, 1120, 0, 7, 2),
  (15, 'Paladin', 55, 100, 40, 370, 270, 290, 75, 2, 10, 2400, 110, 2, 2),
  (16, 'Teutonic Knight', 150, 50, 75, 450, 515, 480, 80, 3, 9, 2960, 80, 2, 2),
  (17, 'Ram', 65, 30, 80, 1000, 300, 350, 70, 3, 4, 4200, 0, 4, 2),
  (18, 'Catapult', 50, 60, 10, 900, 1200, 600, 60, 6, 3, 9000, 0, 5, 2),
  (19, 'Chief', 40, 60, 40, 35500, 26600, 25000, 27200, 4, 5, 70500, 0, 8, 2),
  (20, 'Settler', 10, 80, 80, 7200, 5500, 5800, 6500, 1, 5, 31000, 3000, 6, 2),
  (21, 'Phalanx', 15, 40, 50, 100, 130, 55, 30, 1, 7, 1040, 35, 1, 3),
  (22, 'Swordsman', 65, 35, 20, 140, 150, 185, 60, 1, 6, 1440, 45, 1, 3),
  (23, 'Pathfinder', 0, 20, 10, 170, 150, 20, 40, 2, 17, 1360, 0, 2, 3),
  (24, 'Theutates Thunder', 90, 25, 40, 350, 450, 230, 60, 2, 19, 2480, 75, 2, 3),
  (25, 'Druidrider', 45, 115, 55, 360, 330, 280, 120, 2, 16, 2560, 35, 2, 3),
  (26, 'Haeduan', 140, 50, 165, 500, 620, 675, 170, 3, 13, 3120, 65, 2, 3),
  (27, 'Ram', 50, 30, 105, 950, 555, 330, 75, 3, 4, 5000, 0, 4, 3),
  (28, 'Trebuchet', 70, 45, 10, 960, 1450, 630, 90, 6, 3, 9000, 0, 5, 3),
  (29, 'Chieftain', 40, 50, 50, 30750, 45400, 31000, 37500, 4, 4, 90700, 0, 8, 3),
  (30, 'Settler', 0, 80, 80, 5500, 7000, 5300, 4900, 1, 5, 22700, 3000, 6, 3),
  (31, 'Rat', 10, 25, 20, 85, 75, 120, 25, 1, 7, 1600, 45, 1, 4),
  (32, 'Spider', 20, 35, 40, 125, 130, 60, 40, 1, 7, 1800, 65, 1, 4),
  (33, 'Serpent', 60, 40, 60, 140, 150, 40, 60, 1, 6, 1900, 80, 1, 4),
  (34, 'Bat', 10, 66, 50, 95, 120, 65, 25, 1, 9, 2000, 0, 1, 4),
  (35, 'Wild boar', 50, 70, 33, 250, 200, 125, 45, 2, 10, 2000, 120, 2, 4),
  (36, 'Wolf', 100, 80, 70, 250, 125, 250, 150, 2, 9, 2000, 150, 2, 4),
  (37, 'Bear', 250, 140, 200, 250, 220, 135, 50, 3, 4, 2000, 125, 4, 4),
  (38, 'Crocodile', 450, 380, 240, 125, 250, 300, 65, 3, 3, 2000, 0, 5, 4),
  (39, 'Tiger', 200, 170, 250, 350, 350, 125, 80, 3, 5, 70500, 0, 6, 4),
  (40, 'Elephant', 600, 440, 520, 350, 250, 135, 100, 5, 5, 31000, 3000, 6, 4),
  (41, 'Pikeman', 20, 35, 50, 0, 0, 0, 0, 1, 6, 0, 0, 1, 5),
  (42, 'Thorned Warrior', 65, 30, 10, 0, 0, 0, 0, 1, 7, 0, 0, 1, 5),
  (43, 'Guardsman', 100, 90, 75, 0, 0, 0, 0, 1, 6, 0, 0, 1, 5),
  (44, 'Birds Of Prey', 0, 50, 25, 0, 0, 0, 0, 2, 25, 0, 0, 1, 5),
  (45, 'Axerider', 155, 80, 50, 0, 0, 0, 0, 2, 14, 0, 0, 2, 5),
  (46, 'Natarian Knight', 170, 140, 80, 0, 0, 0, 0, 3, 12, 0, 0, 2, 5),
  (47, 'Warelephant', 250, 120, 150, 0, 0, 0, 0, 4, 5, 0, 0, 4, 5),
  (48, 'Ballista', 60, 45, 10, 0, 0, 0, 0, 5, 3, 0, 0, 5, 5),
  (49, 'Natarian Emperor', 80, 50, 50, 0, 0, 0, 0, 1, 5, 0, 0, 1, 5),
  (50, 'Settler', 30, 40, 40, 0, 0, 0, 0, 1, 5, 0, 0, 1, 5),
  (51, 'Peon', 10, 25, 20, 85, 75, 120, 25, 1, 7, 1600, 45, 1, 6),
  (52, 'Hunter', 20, 35, 40, 125, 130, 60, 40, 1, 7, 1800, 65, 1, 6),
  (53, 'Warrior', 60, 40, 60, 140, 150, 40, 60, 1, 6, 1900, 80, 1, 6),
  (54, 'Hydra', 10, 66, 50, 95, 120, 65, 25, 1, 9, 2000, 0, 1, 6),
  (55, 'Steed', 50, 70, 33, 250, 200, 125, 45, 2, 10, 2000, 120, 2, 6),
  (56, 'War Steed', 100, 80, 70, 250, 125, 250, 150, 2, 9, 2000, 150, 2, 6),
  (57, 'Ram', 250, 140, 200, 250, 220, 135, 50, 3, 4, 2000, 125, 4, 6),
  (58, 'Catapult', 450, 380, 240, 125, 250, 300, 65, 3, 3, 2000, 0, 5, 6),
  (59, 'Chief', 200, 170, 250, 350, 350, 125, 80, 3, 5, 70500, 0, 8, 6),
  (60, 'Settler', 600, 440, 520, 350, 250, 135, 100, 5, 5, 31000, 3000, 6, 6);